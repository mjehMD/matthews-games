...
BUTTON_SOUND_FILE: Final[str] = "button_click.ogg"
CRASH_SOUND_FILE: Final[str] = "crash.ogg"
LEVEL_COMPLETE_SOUND_FILE: Final[str] = "level_complete.ogg"
POWERUP_SOUND_FILE: Final[str] = "powerup.ogg"
